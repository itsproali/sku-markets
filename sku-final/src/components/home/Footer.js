      ...
      >
        ...
        >
          ...
          <Typography sx={{ fontWeight: 'bold', fontSize: '12px' }} component="p">
            <span>&copy;</span> {arabic ? 'جميع الحقوق محفوظة' : 'All rights reserved'} {year}
          </Typography>
        </Grid>
        <Grid
          item
          sx={{ display: 'flex', gap: '3px', justifyContent: 'center', alignItems: 'center' }}
          lg={4}
        >
          <SKUWalletLogo />
        ...
        <Grid sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} item lg={4}>
          <Box sx={{ textDecoration: 'none' }}>
            ...
            <Link
              ...
              to="/help_center"
            >
              {arabic ? 'مركز المساعدة ' : 'Help Center'}
            </Link>
