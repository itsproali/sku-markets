...
import fullRightImgAr from '../../../../assets/images/home-banner/banner-left-static-image-ar1.jpg';
import rightLeftImgAr from '../../../../assets/images/home-banner/banner-left-static-image-ar2.jpg';
...
const TopBanner = ({ arabic }) => {
  const skuIMAGES = [
    { id: 1, img: arabic ? imgAr1 : img1, destination: '/signup' },
    { id: 2, img: arabic ? imgAr2 : img2, destination: '/become_partner' },
    {
      id: 3,
      img: arabic ? imgAr3 : img3,
      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={1}>
          ...
          <Grid xs={12} md={2}>
            <Link to="/signup">
              <img
                src={arabic ? rightLeftImgAr : rightLeftImg}
                alt=""
                height="210px"
                width="100%"
              />
          ...
          <Grid xs={12} md={2}>
            <Link to="/become_partner">
              <img
                src={arabic ? fullRightImgAr : fullRightImg}
                alt=""
                height="210px"
                width="100%"
              />
