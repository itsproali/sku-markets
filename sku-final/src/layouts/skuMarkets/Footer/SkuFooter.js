      ...
      >
        <Box sx={{ minHeight: { md: '220px', lg: '220px', xs: 'auto' } }}>
          <Stack direction="column" justifyContent="space-around" alignItems="center" spacing={1}>
            ...
            >
              {arabic ? 'ماهي منصة اس كي يو ماركتس ؟ ' : 'Who is SKU Markets'}
            </Box>
            <Box
              component={Link}
              to="help_center"
            ...
            >
              {arabic ? 'سياسة اس كي يو ماركتس' : 'SKU Markets Policies'}
            </Box>
          </Stack>
        </Box>
        <Box sx={{ minHeight: { md: '220px', lg: '220px', xs: 'auto' } }}>
          <Stack direction="column" justifyContent="space-around" alignItems="center" spacing={1}>
            ...
            >
              {arabic ? 'إدارة حسابك' : 'Managing Your Account'}
            </Box>
            <Box
              component={Link}
              to="help_center"
            ...
            >
              {arabic ? 'طلب مخزون جديد' : 'Request New stock'}
            </Box>
            <Box
              component={Link}
              to="help_center"
        ...
        <Box sx={{ minHeight: { md: '220px', lg: '220px', xs: 'auto' } }}>
          <Stack direction="column" justifyContent="space-around" alignItems="center" spacing={1}>
            <Typography sx={{ fontWeight: 'bold', mb: 1 }}>
              {arabic ? 'سياسة اس كي يو ماركتس' : 'POLICY'}
            </Typography>
            <Box
              component={Link}
              to="help_center"
            ...
            >
              {arabic ? 'تواجه مشكلة مع منتج' : 'Problem with the Product'}
            </Box>
            <Box
              component={Link}
              to="help_center"
            ...
            >
              {arabic ? 'الضمانات والتأكيدات' : 'Guarantees and Assurances'}
            </Box>
            <Box
              component={Link}
              to="help_center"
            ...
            >
              {arabic ? 'الضمانات والتأكيدات' : 'Return & Refund'}
            </Box>
          </Stack>
        </Box>
        <Box sx={{ minHeight: { md: '220px', lg: '220px', xs: 'auto' } }}>
          <Stack direction="column" justifyContent="space-around" alignItems="center" spacing={1}>
            <Typography sx={{ fontWeight: 'bold', mb: 1 }}>
              {arabic ? 'منصات تواصل اجتماعي' : 'SOCIAL'}
            </Typography>
            <Box>
