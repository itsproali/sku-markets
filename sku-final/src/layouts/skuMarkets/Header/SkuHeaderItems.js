...
const SkuHeaderItems = ({ arabic }) => {
  ...
  return (
    <>
      ...
      >
        {!isMd && <SearchBarInSku arabic={arabic} />}
        <Button
          variant="text"
          color="inherit"
          sx={{
        ...
        >
          {arabic ? 'تسليم الى' : 'Deliver to'} {deliveryCountry}
        </Button>
        ...
        >
          {arabic ? 'كن شريكنا ' : 'Become a Partner'}
        </Button>
        <Button
          variant="text"
          color="inherit"
        ...
        >
          {arabic ? 'المرتجعات والطلبات' : 'Returns & Orders'}
        </Button>
      </Stack>
